...
const apiKey = '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';
...
btn_send.addEventListener('click', async()=>{ //전송버튼을 클릭했을 때 async()에 쓴 값(쳇GPT)을 사용하겠다.
    user_message.classList.remove('display_none')
