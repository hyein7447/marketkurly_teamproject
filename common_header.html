...
<head>
    ...
    <link rel="stylesheet" href="./styles/common_header_m.css">
    <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
</head>
<body>
    <header>
        <div class="pop_up">
            <p>지금 가입하고,<em>1만원 할인 쿠폰</em>받아가세요!</p>
            <div class="reset_btn">
                <a href="#">X</a>
            </div>
        </div>
        ...
        <div class="header_top">
            <div class="left">
                <div class="logo"><img src="./images/main/logo/logo_marketkulry.svg" alt="마켓컬리"></div>
                <div class="menu">
                    <a href="#">마켓컬리</a>
                    <a href="#">뷰티컬리</a>
                </div>
            ...
            <div class="user_info">
                ...
                <a class="wish"><img src="./images/main/icon/icon_wish_off.svg" alt="위시리스트"></a>
                <a class="cart"><img src="./images/main/icon/icon_cart_off.svg" alt="장바구니"></a>
            </div>
        </div>
            ...
            <nav>
                ...
                <div class="gnb_bg"> <!-- 마우스 오버시 출력 JS -->
                    <div class="gnb_wrap">
                        <ul class="gnb">
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_001_off.png" alt="2024 설 선물세트"><span>2024 설 선물세트</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">프리미엄</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_002_off.png" alt="채소"><span>채소</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">친환경</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_003_off.png" alt="과일·견과·쌀"><span>과일·견과·쌀</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">친환경</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_004_off.png" alt="수산·해산·건어물"><span>수산·해산·건어물</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">제철수산</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_005_off.png" alt="정육·가공육·계란"><span>정육·가공육·계란</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">국내산 소고기</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_006_off.png" alt="국·반찬·메인요리"><span>국·반찬·메인요리</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">국·탕·찌개</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_007_off.png" alt="간편식·밀키트·샐러드"><span>간편식·밀키트·샐러드</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">밀키트</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_008_off.png" alt="면·양념·오일"><span>면·양념·오일</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">라면</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_009_off.png" alt="생수·음료·커피"><span>생수·음료·커피</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">생수·탄산수</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_010_off.png" alt="간식·과자·떡"><span>간식·과자·떡</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#"></a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_011_off.png" alt="베이커리"><span>베이커리</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">잼·스프레드</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_012_off.png" alt="유제품"><span>유제품</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">우유·두유</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_013_off.png" alt="건강식품"><span>건강식품</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">비타민·미네랄</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_014_off.png" alt="와인·위스키"><span>와인·위스키</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">레드와인</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_015_off.png" alt="전통주"><span>전통주</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">막걸리·탁주</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_016_off.png" alt="주방용품"><span>주방용품</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">일회용품·주방잡화</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_017_off.png" alt="생활용품·리빙"><span>생활용품·리빙</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">화장지·물티슈</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_018_off.png" alt="가전제품"><span>가전제품</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">주방가전</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_019_off.png" alt="가구·인테리어"><span>가구·인테리어</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">거실가구</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_020_off.png" alt="유아동"><span>유아동</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">분유·간편 이유식</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_021_off.png" alt="스포츠·레져·캠핑"><span>스포츠·레져·캠핑</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">골프</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_022_off.png" alt="반려동물"><span>반려동물</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">강아지 간식·영양제</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_023_off.png" alt="럭셔리뷰티"><span>럭셔리뷰티</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">스킨케어</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_024_off.png" alt="스킨케어·메이크업"><span>스킨케어·메이크업</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">스킨·미스트·패드</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_025_off.png" alt="헤어·바디·구강"><span>헤어·바디·구강</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
                                            <a href="#">구강·면도</a>
                            ...
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_026_off.png" alt="컬리상품권"><span>컬리상품권</span></a>
                                <div class="lnb_bg"></div>
                            </li>
                            <li>
                                <a href="#"><img src="./images/main/icon/category/cate_027_off.png" alt="컬리의 추천"><span>컬리의 추천</span></a>
                                <div class="lnb_bg">
                                    <div class="lnb_wrap">
                                        <div class="lnb">
        ...
        <div class="m_header">
            ...
            <div class="btm_menu">
                <a href="#"><img src="./images/main/icon/icon_home.svg" alt="홈으로가기"></a>
                    ...
                    <div class="gnb_wrap">
                        ...
                        <ul class="gnb">
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_001_off.png" alt="2024 설 선물세트">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_002_off.png" alt="채소">
                                        <span>채소</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_003_off.png" alt="과일·견과·쌀">
                                        <span>과일·견과·쌀</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_004_off.png" alt="수산·해산·건어물">
                                        <span>수산·해산·건어물</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_005_off.png" alt="정육·가공육·계란">
                                        <span>정육·가공육·계란</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_006_off.png" alt="국·반찬·메인요리">
                                        <span>국·반찬·메인요리</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_007_off.png" alt="간편식·밀키트·샐러드">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_008_off.png" alt="면·양념·오일">
                                        <span>면·양념·오일</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_009_off.png" alt="생수·음료·커피">
                                        <span>생수·음료·커피</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_010_off.png" alt="간식·과자·떡">
                                        <span>간식·과자·떡</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_011_off.png" alt="베이커리">
                                        <span>베이커리</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_012_off.png" alt="유제품">
                                        <span>유제품</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_013_off.png" alt="건강식품">
                                        <span>건강식품</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_014_off.png" alt="와인·위스키">
                                        <span>와인·위스키</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_015_off.png" alt="전통주">
                                        <span>전통주</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_016_off.png" alt="주방용품">
                                        <span>주방용품</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_017_off.png" alt="생활용품·리빙">
                                        <span>생활용품·리빙</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_018_off.png" alt="가전제품">
                                        <span>가전제품</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_019_off.png" alt="가구·인테리어">
                                        <span>가구·인테리어</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_020_off.png" alt="유아동">
                                        <span>유아동</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_021_off.png" alt="스포츠·레져·캠핑">
                                        <span>스포츠·레져·캠핑</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_022_off.png" alt="반려동물">
                                        <span>반려동물</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_023_off.png" alt="럭셔리뷰티">
                                        <span>럭셔리뷰티</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_024_off.png" alt="스킨케어·메이크업">
                                        <span>스킨케어·메이크업</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_025_off.png" alt="헤어·바디·구강">
                                        <span>헤어·바디·구강</span>
                                    </div>
                                    <div class="right">
                            ...
                            <li>
                                <a href="#">
                                    <div class="left">
                                        <img src="./images/main/icon/category/cate_026_off.png" alt="컬리상품권">
                                        <span>컬리상품권</span>
                                    </div>
                                    <div class="right">
            ...
            <div class="user_search">
                ...
                <div class="search_bg">
                    ...
                    <a href="#">
                        <span>급상승 검색어<img src="#" alt="급상승 겁색어 도움말"></span>
            ...
            <div class="user_login">
                <div class="title">
                    <a href="#"><img src="#" alt="닫기"></a>
                    <h2>로그인</h2>
                </div>
                <div class="user_id_pw">
                    <input type="text" id="user_id" placeholder="아이디 입력">
                    <input type="password" id="user_pw" placeholder="비밀번호 입력">
                </div>
                <div class="id_save">
                    <input type="checkbox" id="id_save_btn">
                    <label for="id_save_btn" class="fa"><span>아이디 저장</span></label>
                </div>
                <div class="btn">
                ...
                <p>카카오로 <em>간편하게 시작</em>하세요</p>
                <a href="#"><img src="#" alt="카카오">카카오로 시작하기</a>
            </div>
        </div>
    </header>
